 ...
 */
public class SortStudent extends ListStudent {
    /*
    - SBD (mặc định)
    ...
    public int Sort() {
        Vector<StudentInfor> lst_new = new Vector<StudentInfor>();
        lst_new = lst;
        switch (Choice()) {
            case 1:
                Collections.sort(lst_new, new Comparator<StudentInfor>() {
                    public int compare(StudentInfor o1, StudentInfor o2) {
