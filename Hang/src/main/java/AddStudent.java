...
public class AddStudent extends ListStudent {
    ...
    public void Input() {
        try {
            StudentInfor inf = new StudentInfor();
     ...
     */
        ...
        while ((sCurrentLine = brd.readLine()) != null) {
            StudentInfor stCurrent = new StudentInfor();
    ...
    public void InsertSt() throws IOException {
        int ch = Choice();
        switch (ch) {
            case 1:
                if (Keyboard() == 1)
